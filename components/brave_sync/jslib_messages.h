...
#ifndef BRAVE_COMPONENTS_BRAVE_SYNC_JSLIB_MESSAGES_H_
#define BRAVE_COMPONENTS_BRAVE_SYNC_JSLIB_MESSAGES_H_
...
// 1) Chromium everywhere uses `syntax = "proto2";`,
//    sync-lib - `syntax = "proto3";`
// 2) forcing to use version 3 makes to have a deps
//    "//third_party/protobuf:protobuf_full" :
//    marked `Do not use in Chrome code.` in src/third_party/protobuf/BUILD.gn
// 3) even with a depth of a deps "//third_party/protobuf:protobuf_full"
//    there are questions how to convert json -> protobuf class,
//    not all of fields were converted
